...
export const mockQnA: Array<QnA>  = [
  ...
  new QnA(
    "How will Dagger/Hilt fit in with Compose? Can I inject a Composable function? <span id='contribution'>(Contributed by Zach Klipp)</span>", 
  ...
  new QnA(
    "How does one handle orientation changes in Compose? <span id='contribution'>(Contributed by Zach Klipp)</span>", 
  ...
  new QnA(
    "How does navigation work in Compose? <span id='contribution'>(Edits by Brett Best, Zach Klipp)</span>", 
