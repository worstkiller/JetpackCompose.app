...
export const classicAndroidVsJetpackComposeMap = new Map([
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/material/package-summary#alertdialog"
    ),
  ],
  [
    "AppBar",
  ...
  [
    ...
    new JetpackComposeMetadata(
      "Modifier.background",
      "https://github.com/vinaygaba/Learn-Jetpack-Compose-By-Example/blob/master/app/src/main/java/com/example/jetpackcompose/customview/MeasuringScaleActivity.kt#L96",
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/package-summary#background"
    ),
  ],
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/layout/ColumnScope#weight"
    ),
  ],
  [
    "BottomAppBar",
  ...
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/material/package-summary#checkbox"
    ),
  ],
  [
    "ConstraintLayout",
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/layout/package-summary#constraintlayout"
    ),
  ],
  [
    "Dark Mode",
  ...
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/material/package-summary#modaldrawerlayout"
    ),
  ],
  [
    "EditText",
  ...
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/runtime/package-summary#collectasstate"
    ),
  ],
  [
    "FrameLayout",
  ...
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/ui/res/package-summary#loadimageresource"
    ),
  ],
  [
    "ImageView",
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/package-summary#image"
    ),
  ],
  [
    "layer-list shadow",
  ...
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/layout/package-summary.html#padding"
    ),
  ],
  [
    "LinearLayout",
  ...
  [
    ...
    new JetpackComposeMetadata(
      "Modifier.clickable",
      "https://github.com/vinaygaba/Learn-Jetpack-Compose-By-Example/blob/master/app/src/main/java/com/example/jetpackcompose/material/AlertDialogActivity.kt#L65",
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/package-summary.html#clickable"
    ),
  ],
  [
    "Padding",
  ...
  [
    ...
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/material/package-summary3RadioGroup"
    ),
  ],
  [
    "RecyclerView",
    new JetpackComposeMetadata(
      ...
      "https://developer.android.com/reference/kotlin/androidx/compose/foundation/lazy/package-summary.html#lazycolumnfor"
    ),
  ],
  [
    "SavedStateHandle",
  ...
  [
    ...
    new JetpackComposeMetadata(
      "MaterialTheme",
      "https://github.com/vinaygaba/Learn-Jetpack-Compose-By-Example/blob/master/app/src/main/java/com/example/jetpackcompose/theme/DarkModeActivity.kt",
      "https://developer.android.com/reference/kotlin/androidx/compose/material/package-summary#materialtheme"
    ),
  ],
]);
...
export const mockQnA: Array<QnA> = [
  ...
  new QnA(
    ...
    "One of the advantages of declarative programming is that you can model these changes through control flow. In order to change UI based on the size of the screen or the orientation, you can simply us an <i>if condition</i> to handle these changes."
  ),
  new QnA(
